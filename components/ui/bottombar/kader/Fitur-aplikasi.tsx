...
import BottombarKader from "./BottombarKader";
    ...
    return (
        <div className="mb-10">
            ...
            <div className="grid grid-cols-3 gap-y-6 gap-x-4">
                {/* Feature 1: Data Bayi */}
                <Link href="/kader/data-bayi" className="flex flex-col items-center gap-2.5 group">
                ...
                <Link href="/kader/data-imunisasi" className="flex flex-col items-center gap-2.5 group">
                ...
                {/* Feature 3: Edukasi */}
                <Link href="/kader/edukasi" className="flex flex-col items-center gap-2.5 group">
                ...
                <Link href="/kader/data-inventaris" className="flex flex-col items-center gap-2.5 group">
                ...
                {/* Feature 5: Jadwal Posyandu */}
                <Link href="/kader/jadwal-posyandu" className="flex flex-col items-center gap-2.5 group">
                ...
                <Link href="/kader/jadwal-konsultasi" className="flex flex-col items-center gap-2.5 group">
                    ...
                    <span className="text-xs font-bold text-slate-600 text-center">Konsultasi</span>
                </Link>
            </div>
        </div>
    )
