                            ...
                            educations.map((item) => (
                                <div key={item.id} className="bg-white rounded-[1.5rem] p-5 shadow-[0_4px_15px_rgb(0,0,0,0.03)] border border-slate-100 flex flex-col gap-4 relative overflow-hidden">
                                    ...
                                    <div className="flex gap-2 mt-2 pt-4 border-t border-slate-100">
                                        <Link href={`/kader/edukasi/${item.id}`} className="flex-1 bg-blue-50 text-blue-600 text-xs font-bold px-4 py-3 rounded-xl hover:bg-blue-100 hover:text-blue-700 active:scale-95 transition-all flex justify-center items-center gap-1.5">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                            Lihat
                                        </Link>
                                        <Link href={`/kader/edit-edukasi/${item.id}`} className="flex-1 bg-amber-50 text-amber-600 text-xs font-bold px-4 py-3 rounded-xl hover:bg-amber-100 hover:text-amber-700 active:scale-95 transition-all flex justify-center items-center gap-1.5">
