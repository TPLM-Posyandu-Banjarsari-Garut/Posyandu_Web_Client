  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-[0_4px_15px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_6px_20px_rgba(0,0,0,0.04)] flex flex-col gap-3.5 relative group">
      ...
      <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 text-xs flex flex-col gap-2">
        ...
        {/* Posyandu Assignment Row (Khusus Bidan & Kader) */}
        {(feRole === 'bidan' || feRole === 'kader') && (
          <div className="flex items-center gap-2.5 text-slate-700 bg-blue-50/60 rounded-lg px-2 py-1.5 border border-blue-100/70">
            ...
            <span className="text-[11px] font-semibold text-slate-600">
              Bertugas di: <span className="font-bold text-blue-700">{user.posyandu_name || 'Belum Ditugaskan'}</span>
            </span>
          </div>
        )}
