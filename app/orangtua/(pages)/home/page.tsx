...
import { useGetOrangTuaEducations } from "@/hooks/query/orangtua/useOrangTuaChildren";
...
export default function Home() {
  ...
  const { data: educationsData } = useGetOrangTuaEducations({ limit: 1 });
        ...
        <div className="flex-1 overflow-y-auto pb-28 custom-scrollbar">
          ...
          <div className="relative z-10 px-6 pt-10 pb-6">
            ...
            <div className="mb-4">
              ...
              {latestEducation ? (
                <Link href={`/orangtua/baca-edukasi?id=${latestEducation.id}`} className="block bg-gradient-to-br from-blue-500 to-indigo-600 rounded-[1.5rem] p-6 text-white shadow-[0_10px_20px_rgba(79,70,229,0.25)] relative overflow-hidden group cursor-pointer">
