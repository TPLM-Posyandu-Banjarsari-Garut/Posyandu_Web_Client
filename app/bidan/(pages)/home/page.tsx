          ...
          <div className="relative z-10 px-6 pt-10 pb-6">
            ...
            <div className="bg-white rounded-[1.5rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.06)] mb-8 border border-slate-50">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-sm font-bold text-slate-800 tracking-wide">Jadwal Posyandu</h2>
                <span className="px-3 py-1 bg-green-100 text-green-600 rounded-full text-xs font-bold">Aktif</span>
              </div>
              <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                ...
                <div>
                  <p className="text-xs text-slate-500 font-medium mb-1">Tanggal Saat Ini</p>
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center mb-5">
                ...
                <Link href="/bidan/edukasi" className="text-xs font-bold text-blue-600 hover:text-blue-700 bg-blue-50 px-3 py-1.5 rounded-full">Lihat Semua</Link>
              </div>

              {/* Card Edukasi 1 */}
              <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-[1.5rem] p-6 text-white shadow-[0_10px_20px_rgba(79,70,229,0.25)] relative overflow-hidden group cursor-pointer">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg font-bold mb-2 leading-snug">Pentingnya Imunisasi Dasar Lengkap</h3>
                  <p className="text-blue-100 text-xs mb-5 line-clamp-2 leading-relaxed">Imunisasi adalah langkah terbaik untuk melindungi si kecil dari berbagai penyakit berbahaya sejak dini.</p>
                  <button className="bg-white text-indigo-600 text-xs font-bold py-2.5 px-5 rounded-full shadow-sm hover:shadow-md transition-all active:scale-95">
                    Baca Selengkapnya
                  </button>
                </div>
              </div>
