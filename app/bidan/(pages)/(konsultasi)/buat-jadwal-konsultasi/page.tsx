                ...
                <div className="flex-1 overflow-y-auto px-6 py-6 custom-scrollbar bg-slate-50">
                    <div className="bg-white rounded-[1.5rem] p-6 shadow-[0_4px_15px_rgb(0,0,0,0.03)] border border-slate-100 flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2.5">
                            ...
                            <input
                                type="date"
                                className="w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-[1.25rem] text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-inner transition-all"
                            />
                        </div>
                        ...
                        <button className="w-full mt-4 bg-blue-600 text-white font-bold text-sm py-4 rounded-[1.25rem] hover:bg-blue-700 active:scale-95 transition-all shadow-[0_8px_20px_rgba(37,99,235,0.3)] flex justify-center items-center gap-2">
